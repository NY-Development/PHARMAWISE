...
export function LandingPage() {
  return (
    <div className="min-h-screen bg-background-light font-display text-slate-800 transition-colors duration-300 dark:bg-background-dark dark:text-slate-100">
      <nav className="sticky top-0 z-50 border-b border-slate-200 bg-surface-light dark:border-slate-800 dark:bg-surface-dark">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded bg-primary text-white">
              <span className="material-icons text-xl">medical_services</span>
            </div>
            <span className="text-2xl font-bold tracking-tight text-primary">PHARMAWISE</span>
          </div>
          <div className="hidden items-center space-x-8 md:flex">
            <a className="font-medium text-slate-600 transition-colors hover:text-primary dark:text-slate-300" href="#">
              Patients
            </a>
            <a className="font-medium text-slate-600 transition-colors hover:text-primary dark:text-slate-300" href="#">
              Doctors
          ...
          <div className="flex items-center space-x-4">
            <div className="relative hidden sm:block">
              <button className="flex items-center space-x-1 text-slate-500 transition-colors hover:text-primary dark:text-slate-400">
            ...
            <Link className="hidden text-sm font-semibold text-primary transition-colors hover:text-primary-dark sm:block" to="/login">
              Log In
            </Link>
            <Link className="rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-primary-dark hover:shadow-md" to="/register">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <main className="flex-grow">
        <section className="relative overflow-hidden pb-20 pt-12 lg:pb-32 lg:pt-24">
          <div className="pointer-events-none absolute -right-20 -top-20 h-[600px] w-[600px] rounded-full bg-primary/5 blur-3xl" />
          <div className="pointer-events-none absolute -bottom-20 -left-20 h-[400px] w-[400px] rounded-full bg-primary/10 blur-3xl" />
          <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto mb-12 max-w-4xl text-center">
              ...
              <h1 className="mb-6 text-4xl font-bold leading-tight tracking-tight text-slate-900 dark:text-white md:text-6xl">
                ...
                <span className="relative inline-block text-primary">
                  Clearly
                  <svg className="absolute -bottom-1 left-0 h-3 w-full text-primary/20" viewBox="0 0 100 10" preserveAspectRatio="none">
            ...
            <div className="mx-auto max-w-4xl rounded-2xl border border-slate-100 bg-surface-light p-2 shadow-xl transition-all hover:shadow-2xl dark:border-slate-700 dark:bg-surface-dark">
              <div className="flex flex-col gap-2 md:flex-row">
                <div className="flex flex-1 flex-col items-start justify-center rounded-xl border border-slate-100 bg-slate-50 p-6 md:p-8 dark:border-slate-800 dark:bg-background-dark">
                  ...
                  <div className="group relative w-full">
                    <input
                      id="drug-search"
                      className="w-full rounded-lg border-2 border-slate-200 bg-white py-4 pl-4 pr-12 text-lg text-slate-900 shadow-sm transition-colors placeholder:text-slate-400 focus:border-primary focus:ring-0 dark:border-slate-700 dark:bg-surface-dark dark:text-white"
                      placeholder="Enter drug name (e.g. Amoxicillin)"
                      type="text"
                    />
                    <Link className="absolute bottom-2 right-2 top-2 flex items-center justify-center rounded bg-primary px-4 font-medium text-white shadow-sm transition-colors hover:bg-primary-dark" to="/drug-search">
                      Search
                    </Link>
                  </div>
                ...
                <Link
                  className="relative flex cursor-pointer flex-col items-center justify-center rounded-xl border border-dashed border-primary/30 bg-primary/5 p-6 text-center transition-colors hover:bg-primary/10 dark:bg-primary/10 dark:hover:bg-primary/20 md:w-1/3"
                  to="/prescription/upload"
                >
                  <div className="relative z-10 mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-white text-primary shadow-md transition-transform duration-300 group-hover:scale-110 dark:bg-surface-dark">
        ...
        <section className="bg-white py-20 dark:bg-surface-dark">
          <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 sm:px-6 lg:grid-cols-3 lg:px-8">
            {[
              ...
              <div key={card.title} className="rounded-2xl border border-slate-100 bg-background-light p-8 transition-transform duration-300 hover:-translate-y-1 dark:border-slate-800 dark:bg-background-dark">
                <div className={`mb-6 flex h-12 w-12 items-center justify-center rounded-lg bg-blue-100 ${card.tone} dark:bg-blue-900/30`}>
              ...
              <div className="relative z-10 flex flex-col items-center md:flex-row">
                <div className="p-10 text-white md:w-1/2 md:p-16">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link className="rounded-lg bg-white px-6 py-3 font-bold text-primary shadow transition-colors hover:bg-slate-100" to="/register">
                      Register as Doctor
                    </Link>
                    <Link className="rounded-lg border border-white/30 bg-primary-dark/40 px-6 py-3 font-bold text-white backdrop-blur-sm transition-colors hover:bg-primary-dark/60" to="/register">
                      Pharmacist Portal
                    </Link>
                  </div>
                </div>
      ...
      <footer className="border-t border-slate-200 bg-surface-light pt-16 pb-8 dark:border-slate-800 dark:bg-surface-dark">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 grid grid-cols-2 gap-8 md:grid-cols-4">
            <div className="col-span-2 md:col-span-1">
              <div className="mb-4 flex items-center gap-2">
                ...
                <span className="text-xl font-bold text-primary">PHARMAWISE</span>
              </div>
              <p className="mb-4 text-sm text-slate-500 dark:text-slate-400">
                Making healthcare transparent and accessible for everyone.
              </p>
              <div className="flex gap-4 text-slate-400">
                <a className="transition-colors hover:text-primary" href="#"><span className="material-icons">facebook</span></a>
                <a className="transition-colors hover:text-primary" href="#"><span className="material-icons">share</span></a>
                <a className="transition-colors hover:text-primary" href="#"><span className="material-icons">email</span></a>
              </div>
            </div>
            {[
